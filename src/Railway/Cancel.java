    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(txtpnr, javax.swing.GroupLayout.PREFERRED_SIZE, 179, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(67, 67, 67))
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(txtpnr, javax.swing.GroupLayout.PREFERRED_SIZE, 38, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       String pnr = txtpnr.getText();
        try {
            ...
            PreparedStatement pst = con.prepareStatement("select pno from reservationDetails where pno=?");
            pst.setString(1, pnr);
            ResultSet rs = pst.executeQuery();

            if (rs.next()) { // If there is at least one row in the result set
                pst.close();
                con.close();
                int pnrInt = Integer.parseInt(pnr);
                Cancel1 c1 = new Cancel1(pnrInt);
                this.hide();
                c1.setVisible(true);
            } else {
                pst.close();
