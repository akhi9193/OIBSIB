...
private void insertDataIntoDatabase() {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            // TODO add your handling code here:
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost/railway","root","root");
            PreparedStatement pst = con.prepareStatement("select * from loginDetails where username=?");
            ...
            if(rs.next()){
                ...
                if(txtpassword.getText().equals(txtcpass))
                {
                    ...
                    pst = con.prepareStatement("insert into logindetails (username,pass) values (?,?)");
                    pst.setString(1,txtusername.getText());
